    ...
    <section class="panel ar-section ar-section-11 bg-color-cta full-panel">
      <div class="container">
        <div class="narrow-wrap">
          ...
          <p><a class="button white-keyline" href="<?php print $pdf_download; ?>" target="_blank">Download the Report</a><a class="button white-keyline" href="<?php print $pdf_download; ?>" target="_blank">full donor lists</a><a class="button white-keyline" href="<?php print $pdf_download; ?>" target="_blank">view finances</a></p>
        </div>
      </div>
    </section>
