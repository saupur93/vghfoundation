...
var DonationLanding = require('./modules/donationlanding');
  ...
  */
		...
		value: function behaviours() {
			...
			if ((0, _jquery2.default)('.donation-form-landing').length) {
				...
				(0, _jquery2.default)(document).ready(function () {
					...
					(0, _jquery2.default)('#yourdonation').mouseout(function () {
						var yd = (0, _jquery2.default)('#yourdonation').val();

						if (yd == '') {
							(0, _jquery2.default)('#yourdonation').val("$100");
							(0, _jquery2.default)('#yourimpact').val("$200");
						} else {
			...
			if ((0, _jquery2.default)('.expanding-list').length) {
				this.expandingLinks();
			}
   ...
   */
		...
		value: function expandingLinks() {
			...
			var showItems = function showItems() {
				for (var i = displayCount; i < list.find('li').length; i++) {
					(0, _jquery2.default)(list.find('li')[i]).addClass('hide');
				}
			};
			showItems();

			(0, _jquery2.default)('.read-more.list.more').on('click', function () {
				panel.addClass('expanded');
				(0, _jquery2.default)(list.find('li')).removeClass('hide');
			});

			(0, _jquery2.default)('.read-more.list.less').on('click', function () {
  	 ...
  	 */
		...
		key: 'gridSlider',
		value: function gridSlider() {
			var panel = (0, _jquery2.default)('.grid-slider');
			...
			var pagerVisibility = function pagerVisibility() {
				if (currentSlide == 0) {
			...
			panel.find('.pager').on('click', '.right', function () {
				if (currentSlide < items.length - 3) {
					currentSlide++;
					transitionSlides(currentSlide);
					pagerVisibility();
...
},{"./modules/annualReport":8,"./modules/ctamessage":9,"./modules/donationTabs":10,"./modules/donationlanding":11,"./modules/facebookLogin":12,"./modules/fixedHeaderScroll":13,"./modules/miscUI":14,"./modules/newsFeed":15,"./modules/slideshow":16,"./modules/storyheadervideo":17,"./modules/videocover":18,"jquery":2}],8:[function(require,module,exports){
'use strict';
...
var DonationLanding = function () {
  function DonationLanding() {
    _classCallCheck(this, DonationLanding);
  ...
  _createClass(DonationLanding, [{
    key: 'donationForm',
    value: function donationForm() {
      var formEl = $('.donationform');

      //console.log ("entered again");


      formEl.on('keydown', 'input[name="yourdonation"]', function (e) {
...
},{"jump.js":3}],13:[function(require,module,exports){
'use strict';
...
},{"jquery":2,"query-string":4}],16:[function(require,module,exports){
'use strict';
...
var slideshow = {
  ...
  init: function init(container) {
    this.container = container ? (0, _jquery2.default)(container) : (0, _jquery2.default)(this.container);
   ...
   * Pager click events
   */
  pagerEvents: function pagerEvents() {
    var _this = this;
    ...
    (0, _jquery2.default)(this.pagerContainer).on('mouseenter', function () {
      clearTimeout(_this.loop);
    });

    var handleTouchEvents = function handleTouchEvents(e) {
      switch (e.type) {
        case 'swipeleft':
          nextSlide(e);
          break;
   ...
   */
  slideCurrentIndex: function slideCurrentIndex(direction) {
    if (direction === 'right') {
      this.currentSlide++;
    }
   ...
   * Slide transition
   */
  transitionSlides: function transitionSlides(currentSlide) {
    var self = this;
    ...
    var boxColour = this.slideText.eq(currentSlide).data('colour-type');
   ...
   * Auto-transition
   */
  autoTransition: function autoTransition() {
    var _this2 = this;

    this.loop = setTimeout(function () {
      // page left, but not beyond first slide
      if (_this2.currentSlide < _this2.slides.length - 1) {
        _this2.slideCurrentIndex('right');
        _this2.transitionSlides(_this2.currentSlide);
      } else {
        _this2.currentSlide = 0;
        _this2.transitionSlides(_this2.currentSlide);
      }
      _this2.autoTransition();
...
},{"hammerjs":1,"jquery":2}],17:[function(require,module,exports){
'use strict';
